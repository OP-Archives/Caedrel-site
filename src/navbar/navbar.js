...
const socials = [
  {
    path: `https://twitter.com/caedrel`,
    icon: <TwitterIcon color="primary" />,
  },
  {
    path: `https://www.instagram.com/caedrel`,
    icon: <InstagramIcon color="primary" />,
  },
  {
    path: `https://www.youtube.com/Caedrel`,
    icon: <YouTubeIcon color="primary" />,
  },
  {
    path: `https://www.discord.gg/caedrel`,
    icon: (
  ...
  {
    path: `https://www.tiktok.com/@caedrel`,
    icon: (
